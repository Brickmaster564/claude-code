...
Send this summary to #client-network-hub using `python3 tools/slack.py --workspace cn send --channel "#client-network-hub" --text "..."`. Do NOT use Slack MCP for this (it posts as Jasper, not the bot).
